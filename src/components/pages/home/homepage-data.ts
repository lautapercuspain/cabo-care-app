const homepageData = [
  {
    id: 'seguridad-medica',
    name: 'Tranquilidad',
    title: 'Seguridad médica en la palma de tu mano\n',
  ...
  },
  {
    id: 'tu-salud',
    name: 'Tu Salud',
    title: `Porque la salud hoy es la prioridad\n`,
    description: `Pensamos que en caso de emergencia la rapidez con la
